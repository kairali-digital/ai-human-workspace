...
v2.0.0, held v2.0.1 or v2.0.2 worker can take v2.2.0 directly. A pre-v2 worker first needs the
guided exact-scope Gate 0 migration.

**DONE WHEN:** the installed version is `2.2.0`, validation is `PASS`, preserved state
