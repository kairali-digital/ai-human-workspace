...
2. Read `FACTS.md`, `DECISIONS.md`, `TOOLBOX.md`, `GATES.md` and `WORK-GATES.md` only as needed for the
   live task.
...
4. Use only tools and actions allowed by `TOOLBOX.md`, `GATES.md` and `WORK-GATES.md`.
