...
Computer Use may operate only this approved local project. `@Chrome` may operate only
an approved non-LinkedIn public page. Keep Ask for approval and never choose Full
access or Always allow. Before LinkedIn appears, stop every computer/browser tool and
make no more computer or browser tool calls. Do not inspect a screenshot or page
structure, sign in to, open, view, read, control, scrape, search, click, type, copy,
paste, open an attachment, send, or change an account through LinkedIn. The employee
alone performs every LinkedIn action.

Show only this first action:
“YOUR TURN ON LINKEDIN
Computer and browser control are stopped.
Open LinkedIn yourself. Check unread conversations in both Focused and Other. Copy no
more than 25 conversations. Do not copy a password, code, private key, sensitive
personal data, suspicious link, or attachment. Close LinkedIn, return to this local
project, paste the conversations into LINKEDIN-INBOX-BATCH.md with sender display name
or initials, date, relevant conversation text, and Focused or Other, then say BATCH
READY.”

Wait. Do not continue until LinkedIn is closed and the employee says BATCH READY.
...
“Computer and browser control are stopped. Review every draft. If you approve one,
manually paste and send it in LinkedIn. Then close LinkedIn, return here, and
