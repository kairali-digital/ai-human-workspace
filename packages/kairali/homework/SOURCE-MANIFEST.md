...
## Owner and Kairali sources

- Owner instruction in `GENERAL-AI-HUMAN-HOMEWORK-001`, 12 Aug 2026: every attendee
  without a named plan completes Email Triage and Drive Inventory; LinkedIn is optional;
  instructions and video must be extremely simple and include all prompts.
- `context/ROLLOUT-ARCHITECTURE.md` - Iron Man model, controlled loop, state files,
  Setup Helper, first-session and close-out sequence.
...
- Google Doc: “Build Your Own Prompts Using Meta Prompts - For Videos - c12 Outskill
  Video Creation and ad Creation”. Pattern used: show the whole workflow, give one exact
...
- https://learn.chatgpt.com/docs/app - desktop flow: install, sign in, choose where to
