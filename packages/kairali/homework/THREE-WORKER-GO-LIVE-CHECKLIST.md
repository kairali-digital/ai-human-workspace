# Three-worker go-live checklist

The public release and portal make all three starter folders **AVAILABLE**. They do not
connect your accounts, choose your times or activate your workers.
...
- your chosen Saturday local time and confirmed time zone match;
- the reminder opens only this separate local project;
- task-scoped local Computer control passes with Ask for approval;
...
If a line is blocked, paste the complete Setup Helper rescue prompt. The helper gives
one next action, waits and verifies it.

Use this checklist with the full beginner instructions in `START-HERE.md` and
