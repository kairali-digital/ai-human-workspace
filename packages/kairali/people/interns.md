...
Your mission is one assigned page from research through proof, never live. You choose the page goal and review every draft. Codex prepares the work, checks it and stops at Gate 0 or any publishing decision.

**Your list:** One page, taken all the way — not live
**Where it is:** https://docs.google.com/spreadsheets/d/1CdGnvkScfZhraQrFJq2oLef3VF2xcWmwXnbMoQ9mGX4/edit
**Open rows on your name today:** off the page list
...
Take **one page** from start to finish. Do not put it live.

## 1. Research

```
Research this page topic. Tell me what people search for,
what our competitors say, and what we are missing.
```

## 2. Content

```
Write the page. Plain language, our tone, no invented claims.
Show me the draft before anything else.
```

## 3. SEO

```
Give me the title, meta description, headings and internal links for this page.
...
```
What needs tagging on this page, and what event should fire?
```
