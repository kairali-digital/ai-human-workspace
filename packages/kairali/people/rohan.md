...
**Open rows on your name today:** 15
...
```
Fix the highest-impact defects, up to 25.
For each one: before, after, how to undo it.
```

You and Vikash are paired. Compare your two audits before you bring them to Abilash.
---
