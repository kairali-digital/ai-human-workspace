...
**Open rows on your name today:** 194
...
## 1. Look at one dashboard

```
Open this dashboard. Tell me:
- what is broken
- what data is stale
...
```
Fix the first item on that list.
Show me before, after, and how to undo it.
```

## 3. Forms cutover on the website port

You own this. Forms are never cloned from the old sites.

```
Build one standard form component for the factory.
Same fields, same inbox, every site.
Then list every form on the old sites and tell me which ones it replaces,
and which ones need something custom.
```

## 4. Hand it to your team

```
Write these same steps as a short guide my team can follow without me.
Plain language. No jargon. One action per line.
```
---
