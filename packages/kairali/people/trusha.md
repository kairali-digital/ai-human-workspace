...
Your mission is one SEO defect from your property list. You judge priority and the acceptable result. Codex finds, structures, fixes only the approved work and records proof. Claims and publishing decisions stop for human review.

**Your list:** SEO defect list for one property
**Where it is:** https://docs.google.com/spreadsheets/d/19MP_sEVE8JrC2hOMXbhhGDWTGCOcfoVTwLj0M422Di0/edit
**Open rows on your name today:** 2
...
```
Go through this property and find SEO defects:
titles, meta descriptions, headings, alt text, broken links,
redirects, sitemap, page speed, indexing.
Give me a list. Fix nothing yet.
```

## 2. Write them as rows

```
Turn that list into register rows. One row per defect.
Each row: ID, what is wrong, which URL, how bad, what proves it.
```

## 3. Sort by effort against impact

```
Sort those rows: high impact and low effort first.
Tell me which five you would do this week.
```
---
