...
export const downloadGroups: DownloadGroup[] = [
    ...
    items: [
      {
        ...
        file: "KAIRALI-AI-METHOD-ROLLOUT-v14-PUBLIC-KIT.zip",
        format: "ZIP",
      },
      {
        label: "Checksum",
        description: "Use this only when IT or a technical facilitator verifies the download.",
        file: "KAIRALI-AI-METHOD-ROLLOUT-v14-PUBLIC-KIT.sha256",
        format: "SHA-256",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        label: "Homework pack",
        description: "Guide, prompts, video, captions and three starters: chosen-time daily email brief, TEST 25 or resumable FULL DRIVE INDEX, plus optional Saturday LinkedIn drafts with human-only access and sending.",
