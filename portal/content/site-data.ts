...
export const downloadGroups: DownloadGroup[] = [
    ...
    items: [
      {
        ...
        file: "KAIRALI-AI-METHOD-ROLLOUT-v13-PUBLIC-KIT.zip",
        format: "ZIP",
      },
      {
        label: "Checksum",
        description: "Use this only when IT or a technical facilitator verifies the download.",
        file: "KAIRALI-AI-METHOD-ROLLOUT-v13-PUBLIC-KIT.sha256",
        format: "SHA-256",
      },
    ],
  },
  ...
  {
    title: "Homework",
    description: "The daily Email Importance Brief and Drive Index are required. LinkedIn is optional after both pass.",
    items: [
      {
        label: "Homework pack",
        description: "Guide, prompts, video, captions and three starters, including a chosen-time daily email brief and TEST 25 or resumable FULL DRIVE INDEX.",
