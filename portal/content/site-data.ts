    ...
    items: [
      {
        ...
        file: "KAIRALI-AI-METHOD-ROLLOUT-v15-PUBLIC-KIT.zip",
        format: "ZIP",
      },
      {
        label: "Checksum",
        description: "Use this only when IT or a technical facilitator verifies the download.",
        file: "KAIRALI-AI-METHOD-ROLLOUT-v15-PUBLIC-KIT.sha256",
        format: "SHA-256",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "The eleven-page printable employee guide.",
