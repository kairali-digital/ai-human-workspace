...
const required = new Set([
  "AI-HUMAN-v220-REUSABLE-EDITION-PUBLIC-KIT.zip",
  "AI-HUMAN-v220-REUSABLE-EDITION-PUBLIC-KIT.zip.sha256",
  "KAIRALI-AI-HUMAN-v220-EMPLOYEE-EDITION-PUBLIC-KIT.zip",
  "KAIRALI-AI-HUMAN-v220-EMPLOYEE-EDITION-PUBLIC-KIT.zip.sha256",
...
for (const phrase of ["Kairali employee edition", "Reusable edition", "Install in five steps", "DONE WHEN", "Mac", "Windows", "Extract All", "Suspend", "Resume", "Uninstall", "Revoke access", "Troubleshooting", "Polite pushback, then a useful path forward", "nearest compliant next step", "SUSPENDED", "UNINSTALLED", "Plugin uninstall can also leave its connector connected", "Use the Setup Helper", "Use the smallest path that matches the effect.", "One document with 150 rows uploads intact", "Creating 150 GitHub issues", "No universal compliance shortcut.", "exact legal entity", "Historical charts", "Unanswered compliance questions block ACTIVE.", "separate worker folders and profiles", "One kind of data, one file of record", "gate-profile.json", "COMPLETED_LEDGER.md", "Personal Work Memory + Daily Email EA", "fixed-time Email EA", "NOT SENT", "DRIVE-INDEX.jsonl", "DRIVE-REGISTER.csv", "one generation", "weekly refresh", "FULL DRIVE INDEX", "Saturday LinkedIn Message Assistant", "right-level local control", "human-only LinkedIn access and sending", "Available here. Live only after your proof.", "LIVE FOR ME", "TEST 25 proves setup only", "NOT ENABLED BY CHOICE", "@Computer", "YOUR TURN ON LINKEDIN", "The portal cannot grant computer access", "GitHub stays the approved source of truth", "CHECK FOR KAIRALI UPDATE", "CHECK FOR AI-HUMAN UPDATE", "UPDATE NOW", "Fetch/Pull", "read-only", "Monitor", "v2.2.0", "user-owned state preserved"]) {
