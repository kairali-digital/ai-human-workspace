...
`.ai-human/system/AGENT-RULES.md` and `.ai-human/system/AI-HUMAN.md`, then
`COMPANY.md`, `PARAMETERS.md`, `ROLE.md`, `.ai-human/control/gate-profile.json`,
`GATES.md`, `COMPLIANCE-SOURCES.md`, `WORK-GATES.md`, `MASTER_CURSOR.md`,
`OPEN_REGISTER.md` and `TODAY.md`. Project facts belong in `FACTS.md`; rulings belong
in `DECISIONS.md`.
